...
# ---- LOGOUT ----
    ...
    selected = option_menu (
        ...
        options= ["Home Screen","Do you have malaria","App Guide","Privacy"],
    ...
    if selected == "Home Screen":
        st.header("Get quick diagnosis for Malaria")
        st.write("check on your health status today, your health matters.")

        
    if selected == "Do you have malaria":
        # Load the trained model
        model  = joblib.load('malaria.pkl')
        ...
        if st.button('Predict'):
            ...
            if prediction[0] == 1:
                st.write("Not very Proabable you  have malaria soon but still take good care of yourself regardless")
            else:
                st.write("It is Probable you might have malaria soon therfore you should see a doctor")

    if selected == "App Guide":
        st.title(f'Malaria Dignosis App Guide {selected}')

        '''
        Welcome to the Malaria Dignosis App guide. This app is designed to help users detect the signs of a malaria early and provide immediate guidance on what to do in such a situation. Please read this guide to familiarize yourself with the app's features and functionality
        1. Installation and Setup:
        - Install the neceesary requirements
        - Launch the app on any broswer of your choice using the code "streamlit run app.py" on your terminal
        
        2. App Navigation:
        - Use the navigation menu or icons to access different sections of the app.
        
        4. Malaria Detection:
        - To detect signs of a malaria, select the "Do you have malaria" feature from the app's main screen.
        ...
        Conclusion:
        Congratulations! You are now familiar with the Malaria Detection App. Use the app responsibly to monitor your health and seek professional medical assistance when necessary. Remember, the app is not a substitute for professional medical advice, and it is essential to consult a healthcare professional for a proper diagnosis and treatment. Stay healthy and take care!
        '''

    if selected == "Privacy":
        st.title("App's Privacy Policy")
        '''
        Privacy Policy for Malaria Diagnosis App

        At Malaria DIAGNOSTICS, we take your privacy seriously. This Privacy Policy outlines how we collect, use, disclose, and safeguard your personal information when you use our Malaria Diagnosis App (referred to as the "App").
